...
var star1, star2;
var starImg;
var empty_stars,starsDisplay;
var one_star, two_stars;
...
function preload()
{
  ...
  empty_stars = loadAnimation('empty.png');
...
function setup() 
{
  ...
  star2 = createSprite(70,330,20,20);
  star2.addImage(starImg);
  star2.scale=0.02;

  starsDisplay = createSprite(50, 50, 30, 30);
  starsDisplay.scale = 0.2;
  starsDisplay.addAnimation('empty',empty_stars);
  starsDisplay.addAnimation('two',two_stars);
  starsDisplay.addAnimation('one',one_star);
  starsDisplay.changeAnimation('empty',empty_stars);
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   if(collide(star1,starsDisplay,10)==true){
    star1.visible = false;
    starsDisplay.changeAnimation('one')
   }

   if(collide(star2,starsDisplay,10)==true){
     star2.visible = false;
     starsDisplay.changeAnimation('two');
   }
